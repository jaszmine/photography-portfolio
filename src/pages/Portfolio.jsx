...
//   const [filteredImages, setFilteredImages] = useState([]);
//   const [isLoading, setIsLoading] = useState(false);
//   const [scrambleKey, setScrambleKey] = useState(0); // Used to trigger rescrambling
...
//   // Function to rescramble when needed
//   const handleRescramble = useCallback(() => {
//     if (activeCategory === 'all') {
//       rescrambleAll();
//       setScrambleKey(prev => prev + 1);
...
//     const timeout = setTimeout(() => {
//       // For 'all' category, get scrambled images
//       if (activeCategory === 'all') {
//         setFilteredImages(getImagesByCategory('all', true));
//       } else {
//         // For specific categories, maintain original order
//         setFilteredImages(getImagesByCategory(activeCategory, false));
//       }
//       setIsLoading(false);
//     }, 300);
...
//     return () => clearTimeout(timeout);
//   }, [activeCategory, scrambleKey]); // Re-run when scrambleKey changes

//   /* If wanted to scramble only once on page load:
//     useEffect(() => {
//       // Scramble only once when component mounts
